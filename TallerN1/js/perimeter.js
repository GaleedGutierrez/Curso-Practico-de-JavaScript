...
function calculatePerimeter() {
    ...
    selectedCalculatePerimeter(figures, figureSelect, valuesSides);
}

function selectedCalculatePerimeter(figures, figureSelect, valuesSides) {
    switch (figureSelect) {
        case figures[0]:
            let sidesSquare = valuesSides[0].sides;
            calculateSquarePerimeter(sidesSquare);
            break;
        case figures[1]:
